...
describe('#LexService', () => {
  ...
  describe('#Params Validation', () => {
    it('should fail if the session is undefined', () => {
      return LexService.buildResponse(undefined).should.be.rejectedWith('session was not supplied');
    });
  });
  ...
  describe('#Business Logic', () => {
    it('should succeed and return a valid response object', () => {
      ...
      return Bluebird.resolve()
        .then(() => LexService.buildResponse(session))
    ...
    it('should return an empty array when clearCompleted is set true', () => {
      ...
      return Bluebird.resolve()
        .then(() => LexService.buildResponse(session, clearCompleted))
        .then(res => {
